...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pytest-postgresql-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pytest-postgresql-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pytest-postgresql
# for installing globally
pixi global install pytest-postgresql
```
...
It is possible to list all of the versions of `pytest-postgresql` available on your platform:
...
```
pixi search pytest-postgresql --channel conda-forge
```
